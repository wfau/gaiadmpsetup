...
gaiadr3_vari_time_series_statistics_schema = StructType([
...
gaiadr3_alerts_mixedin_sourceids_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_astrophysical_parameters_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_astrophysical_parameters_supp_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Source Identifier
...
gaiadr3_epoch_photometry_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_gaia_source_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_galaxy_candidates_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
...
gaiadr3_galaxy_catalogue_name_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
...
gaiadr3_mcmc_samples_gsp_phot_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
...
gaiadr3_mcmc_samples_msc_schema = StructType([
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_nss_acceleration_astro_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Source Identifier
...
gaiadr3_nss_non_linear_spectro_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Source Identifier
    StructField('nss_solution_type', StringType(), True), # NSS model adopted
...
gaiadr3_nss_two_body_orbit_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Source Identifier
...
gaiadr3_nss_vim_fl_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Source Identifier
    StructField('nss_solution_type', StringType(), True), # NSS model adopted
    StructField('ra', DoubleType(), True), # Right ascension
...
gaiadr3_oa_neuron_information_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_oa_neuron_xp_spectra_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('neuron_id', LongType(), False), # Neuron identifier
    StructField('neuron_row_index', ShortType(), True), # Row index of the neuron in the Self-Organised Map lattice
    StructField('neuron_column_index', ShortType(), True), # Column index of the neuron in the Self-Organised Map lattice
...
gaiadr3_qso_candidates_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
...
gaiadr3_qso_catalogue_name_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
    StructField('catalogue_id', ByteType(), False), # The unique identifier for the catalogue(s) used to select the sources in the morphological analysis
])
gaiadr3_rvs_mean_spectrum_schema = StructType([
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('ra', DoubleType(), True), # Right Ascension
    StructField('dec', DoubleType(), True), # Declination
...
gaiadr3_sso_reflectance_spectrum_schema = StructType([
    StructField('source_id', LongType(), False), # Source identifier
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('number_mp', LongType(), True), # Minor Planet number
    StructField('denomination', StringType(), True), # standard MPC denomination of the asteroid
...
gaiadr3_sso_source_schema = StructType([
...
gaiadr3_total_galactic_extinction_map_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_total_galactic_extinction_map_opt_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('healpix_id', LongType(), False), # HEALPix identification
...
gaiadr3_vari_agn_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
    StructField('fractional_variability_g', FloatType(), True), # Fractional variability in the G band
    StructField('structure_function_index', FloatType(), True), # Index of the first-order structure function in the G band
...
gaiadr3_vari_classifier_class_definition_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_vari_classifier_definition_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('classifier_name', StringType(), False), # Name of the classifier that is detailed in this entry
    StructField('classifier_description', StringType(), True), # Description of this classifier
])
gaiadr3_vari_classifier_result_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
...
gaiadr3_vari_compact_companion_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
    StructField('period', DoubleType(), True), # Orbital period
...
gaiadr3_vari_eclipsing_binary_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
...
gaiadr3_vari_epoch_radial_velocity_schema = StructType([
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
...
gaiadr3_vari_long_period_variable_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
...
gaiadr3_vari_microlensing_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
...
gaiadr3_vari_ms_oscillator_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
...
gaiadr3_vari_planetary_transit_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
...
gaiadr3_vari_rad_vel_statistics_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
...
gaiadr3_vari_short_timescale_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Unique source identifier
...
gaiadr3_xp_continuous_mean_spectrum_schema = StructType([
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_xp_merge_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_xp_sampled_mean_spectrum_schema = StructType([
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('ra', DoubleType(), True), # Right Ascension
    StructField('dec', DoubleType(), True), # Declination
...
gaiadr3_xp_sampling_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_xp_summary_schema = StructType([
    StructField('source_id', LongType(), False), # Unique source identifier (unique within a particular Data Release)
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('bp_n_relevant_bases', ShortType(), True), # Number of bases that are relevant for the representation of this mean BP spectrum
    StructField('bp_relative_shrinking', FloatType(), True), # Measure of the relative shrinking of the coefficient vector when truncation is applied for the mean BP spectrum
...
gaiadr3_commanded_scan_law_schema = StructType([
...
gaiadr3_agn_cross_id_schema = StructType([
...
gaiadr3_frame_rotator_source_schema = StructType([
    StructField('source_id', LongType(), False), # Gaia source identifier
...
gaiadr3_gaia_crf3_xm_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
    StructField('source_id', LongType(), False), # Gaia source identifier
...
gaiadr3_gaia_source_simulation_schema = StructType([
    StructField('solution_id', LongType(), True), # Solution Identifier
...
gaiadr3_gaia_universe_model_schema = StructType([
...
# N.B. load scripts bucket by source ID: what to do if no such column?!
