...
gaiaedr3_gaia_source_schema = StructType([
...
gaiaedr3_twomass_psc_schema = StructType([
            StructField('ra', DoubleType(), True),
            StructField('dec', DoubleType(), True),
...
gaiaedr3_allwise_sc_schema = StructType([
            StructField('designation', StringType(), True),
            StructField('ra', DoubleType(), True),
            StructField('dec', DoubleType(), True),
...
gaiaedr3_panstarrs_dr1_otmo_schema = StructType([
...
# PS1
gaiaedr3_panstarrs1_best_neighbour_schema = StructType([
            StructField('source_id', LongType(), True),
...
# ALLWISE:
gaiaedr3_allwise_best_neighbour_schema = StructType([
            StructField('source_id', LongType(), True),
...
# 2MASS:
gaiaedr3_tmasspscxsc_best_neighbour_schema = StructType([
            StructField('source_id', LongType(), True),
            StructField('original_ext_source_id', StringType(), True),
            StructField('angular_distance', FloatType(), True),
            StructField('xm_flag', ShortType(), True),
